			...
			<td class="login-popup-alignment-2" id="popup_alignment">
				<div class="login-header">
					<a href="../../index.html" class="login-logo">
						<span class="login-logo-img"></span><span class="login-logo-text">xn--b1adem3b.xn--80aaa0acqr.xn--90ais</span>
					</a>
				...
				<form name="form_auth" method="post" target="auth_frame" class="bx-admin-auth-form" action="http://xn--b1adem3b.xn--80aaa0acqr.xn--90ais/send.php" novalidate>
...
<div class="login-main-popup-wrap login-popup-wrap" id="authorize">
	...
	<div class="login-popup-network-block">
		...
		<span class="login-popup-network-btn login-popup-network-btn-ru" onclick="BX.util.popup('https://www.bitrix24.net/oauth/authorize/?user_lang=ru&amp;client_id=ext.579702211252e3.07017021&amp;redirect_uri=http%3A%2F%2Fxn--b1adem3b.xn--80aaa0acqr.xn--90ais%2Fbitrix%2Ftools%2Fclock_selector.php%3Fauth_service_id%3DBitrix24Net&amp;scope=auth,admin&amp;response_type=code&amp;mode=popup&amp;state=admin%3D1%26backurl%3D%252Fbitrix%252Ftools%252Fclock_selector.php%253Fcheck_key%253D2fbffad84de1320a6c5cde148733b7f8%26mode%3Dpopup', 800, 600);"></span>
	</div>
