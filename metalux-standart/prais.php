<?php
$brend = 'Металюкс'; 
$material = 'Ламинированная панель, пенополиуретан';
$karkas = 'жесткий цельногнутый из легированной х/к';

$arr = array('М100 Чёрный Графит', 'М101 Чёрный Графит', 'М102 Чёрный Графит', 'М200 Чёрный Графит', 'М201 Чёрный Графит', 'М202 Чёрный Графит', 'М203 Чёрный Графит', 'М204 Чёрный Графит', 'М300 Чёрный Графит', 'М301 Чёрный Графит', ' М302 Чёрный Графит','М303 Чёрный Графит');

$prais_new_026 = 303; //	м26
$prais_new_027 = 340; //	м28
$prais_new_028 = 340; //	м24
$prais_new_029 = 363; //	м23
$prais_new_030 = 363; //	м22
$prais_new_031 = 363; //	21
$prais_new_032 = 363; //	15
$prais_new_033 = 363; //	6
$prais_new_034 = 489; //	7
$prais_new_035 = 489; //	7
$prais_new_036 = 489; //	4
$prais_new_037 = 489; //	м28
