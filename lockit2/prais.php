...
$arr = array('Феррара SN', 'Феррара АВ', 'Рокка MCF', 'Салерно SN+PC', 'Страда SN+PC', 'Тироль AB', 'Тироль SN+PC', 'Тренто AB', 'Тренто SN+PC', 'Триест SN+PC', 'Триест TB+PC');

$prais_new_026 = 19; //	Феррара SN
$prais_new_027 = 19; //	Феррара АВ
