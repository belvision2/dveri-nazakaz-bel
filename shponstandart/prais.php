...
$brend = 'Юркас'; 
$material = 'Шпон';
$karkas = 'Клееный массив сосны';

$arr = array('Греция-ДГ, мореный дуб', 'Греция-ДО, мореный дуб, фьюзинг', 'Лаура-ДГ, мореный дуб', 'Лаура-ДО, мореный дуб, фацет', 'Лилия-4-ДГ, мореный дуб, беленый дуб', 'Лилия-4-ДО, мореный дуб, беленый дуб', 'Бретань-ДО Дуб', 'Бретань-ДГ Дуб', 'Бретань-ДО Орех', 'Бретань-ДГ Орех', 'Камелия-ДО Дуб', 'Камелия-ДГ Дуб', 'Камелия-ДО Орех', 'Камелия-ДГ Орех', 'Орхидея-ДО дуб', 'Орхидея-ДГ дуб', 'Корона-ДО дуб', 'Корона-ДГ дуб', 'Мария-ДО Дуб', 'Мария-ДГ Дуб', 'Неаполь-ДО Дуб', 'Неаполь-ДГ дуб', 'Неаполь-ДО орех', 'Неаполь-ДГ орех', 'Кардинал-ДО Дуб', 'Кардинал-ДГ Дуб', 'Кардинал-ДО Орех', 'Кардинал-ДГ Орех', 'Ниагара-ДО Беленый дуб', 'Ниагара-ДО Орех');

$prais_new_026 = 360; //	Греция-ДГ, мореный дуб
$prais_new_027 = 414; //	Греция-ДО, мореный дуб, фьюзинг
$prais_new_028 = 253; //	Лаура-ДГ, мореный дуб
$prais_new_029 = 318; //	Лаура-ДО, мореный дуб, фацет
$prais_new_030 = 264; //	Лилия-4-ДГ, мореный дуб, беленый дуб
$prais_new_031 = 256; //	Лилия-4-ДО, мореный дуб, беленый дуб
$prais_new_032 = 284; //	Бретань-ДО Дуб
$prais_new_033 = 225; //	Бретань-ДГ Дуб
$prais_new_034 = 286; //	Бретань-ДО Орех
$prais_new_035 = 225; //	Бретань-ДГ Орех
$prais_new_036 = 283; //	Камелия-ДО Дуб
$prais_new_037 = 250; //	Камелия-ДГ Дуб
$prais_new_038 = 283; //	Камелия-ДО Орех
$prais_new_039 = 250; //	Камелия-ДГ Орех
$prais_new_040 = 253; //	Орхидея-ДО дуб
$prais_new_041 = 239; //	Орхидея-ДГ дуб
$prais_new_042 = 253; //	Корона-ДО дуб
$prais_new_043 = 239; //	Корона-ДГ дуб
$prais_new_044 = 253; //	Мария-ДО Дуб
$prais_new_045 = 239; //	Мария-ДГ Дуб
$prais_new_046 = 299; //	Неаполь-ДО Дуб
$prais_new_047 = 246; //	Неаполь-ДГ дуб
$prais_new_048 = 299; //	Неаполь-ДО орех
$prais_new_049 = 246; //	Неаполь-ДГ орех
$prais_new_050 = 261; //	Кардинал-ДО Дуб
$prais_new_051 = 225; //	Кардинал-ДГ Дуб
$prais_new_052 = 225; //	Кардинал-ДО Орех
$prais_new_053 = 225; //	Кардинал-ДГ Орех
$prais_new_054 = 428; //	Ниагара-ДО Беленый дуб
$prais_new_055 = 414; //	Ниагара-ДО Орех
