<?php
$brend = 'Порта'; 
$material = 'плита ХДФ,сотопанель';
$karkas = 'LVL-брус, тамбурат';

$arr = array('Порта-50А-6 Cappuccino Crosscut','Порта-50А-6 Grey Crosscut','Порта-50А-6 Wenge Crosscut','Порта-50А-6 Bianco Crosscut','Порта-50 Bianco Crosscut','Порта-50 Cappuccino Crosscut','Порта-50 Grey Crosscut','Порта-50 Wenge Crosscut','Порта-51 Bianco Crosscut','Порта-51 Cappuccino Crosscut','Порта-51 Grey Crosscut','Порта-51 Wenge Crosscut');

$prais_new_026 = 213; //	17L Белый люкс, графит
$prais_new_027 = 213; //	17L Магнолия люкс, графит
$prais_new_028 = 213; //	17L Терра, графит
$prais_new_029 = 213; //	29L Белый люкс, графит
$prais_new_030 = 157; //	29L Белый люкс, черный триплекс
$prais_new_031 = 157; //	29L Терра, графит
$prais_new_032 = 157; //	37L Белый люкс, графит
$prais_new_033 = 157; //	37L Магнолия люкс, графит
$prais_new_034 = 198; //	37L Терра, графит
$prais_new_035 = 198; //	45L Белый люкс, графит
$prais_new_036 = 198; //	45L Магнолия люкс, графит
$prais_new_037 = 198; //	45L Терра, графит
