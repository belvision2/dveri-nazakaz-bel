<?php
$brend = 'Производство РФ';
$material = 'ПВХ';
$karkas = 'пластиковые направляющие';

$arr = array('Гармошка-ФАВОРИТ Вишня', 'Гармошка-ФАВОРИТ Дуб старый', 'Гармошка-ФАВОРИТ Венге', 'Гармошка-ФАВОРИТ Миланский орех', 'Гармошка-ФАВОРИТ Серый ясень', 'Гармошка СТИЛЬ Вишня', 'Гармошка СТИЛЬ Груша карат', 'Гармошка СТИЛЬ Ясень серый', 'Гармошка СТИЛЬ Ясень Миланский орех', 'Гармошка СТИЛЬ Ясень Венге');
$prais_new_026 = 125; //	
$prais_new_027 = 125; //	
$prais_new_028 = 125; //	
$prais_new_029 = 125; //	
