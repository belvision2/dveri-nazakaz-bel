...
$arr = array('Рим SN+PC', 'Риола MCF', 'Рокка MCF', 'Салерно SN+PC', 'Страда SN+PC', 'Тироль AB', 'Тироль SN+PC', 'Тренто AB', 'Тренто SN+PC', 'Триест SN+PC', 'Триест TB+PC');

$prais_new_026 = 31; //	Рим SN+PC
$prais_new_027 = 31; //	Риола MCF
$prais_new_028 = 31; //	Рокка MCF
$prais_new_029 = 31; //	Салерно SN+PC
$prais_new_030 = 31; //	Страда SN+PC
$prais_new_031 = 31; //	Тироль AB
$prais_new_032 = 31; //	Тироль SN+PC
$prais_new_033 = 31; //	Тренто AB
$prais_new_034 = 31; //	Тренто SN+PC
$prais_new_035 = 31; //	Триест SN+PC
$prais_new_036 = 31; //	Триест TB+PC
