...
$arr = array( 'ЮрСталь ДВ-1 ', 'ЮрСталь Каскад ', 'ЮрСталь Крит ', 'ЮрСталь Лайн ', 'ЮрСталь Монреаль ', 'ЮрСталь Троя ', 'ЮрСталь Турин ', 'ЮрСталь Манчестер ', 'ЮрСталь Сенатор ', 'ЮрСталь Токио ', 'ЮрСталь Версаче премиум ', 'ЮрСталь Лацио ', 'ЮрСталь Лацио Белая ', 'ЮрСталь Луна ', 'ЮрСталь Милано ', 'ЮрСталь Лондон ', 'ЮрСталь Рим ', 'ЮрСталь Элит ', 'ЮрСталь Квадром');

$prais_new_026 = 615; //	'ЮрСталь ДВ-1
$prais_new_027 = 594; //	 ', 'ЮрСталь Каскад
$prais_new_028 = 598; //	 ', 'ЮрСталь Крит
$prais_new_029 = 598; //	 ', 'ЮрСталь Лайн
$prais_new_030 = 594; //	 ', 'ЮрСталь Монреаль
$prais_new_031 = 724; //	 ', 'ЮрСталь Троя
$prais_new_032 = 866; //	 ', 'ЮрСталь Турин
$prais_new_033 = 598; //	 ', 'ЮрСталь Манчестер
$prais_new_034 = 594; //	 ', 'ЮрСталь Сенатор
$prais_new_035 = 817; //	 ', 'ЮрСталь Токио
$prais_new_036 = 1267; //	 ', 'ЮрСталь Версаче премиум
$prais_new_037 = 1436; //	 ', 'ЮрСталь Лацио
$prais_new_038 = 1436; //	 ', 'ЮрСталь Лацио Белая
$prais_new_039 = 1110; //	 ', 'ЮрСталь Луна
$prais_new_040 = 1207; //	 ', 'ЮрСталь Милано
$prais_new_041 = 1063; //	 ', 'ЮрСталь Лондон
$prais_new_042 = 1110; //	 ', 'ЮрСталь Рим
$prais_new_043 = 1063; //	 ', 'ЮрСталь Элит
$prais_new_044 = 817; //	 ', 'ЮрСталь Квадром
$prais_new_045 = 100; //	72U Аляска
$prais_new_046 = 100; //	72U Антрацит
$prais_new_047 = 100; //	72U Магнолия Сатинат
$prais_new_048 = 100; //	45U Чёрный матовый
$prais_new_049 = 100; //	46U Чёрный матовый
$prais_new_050 = 100; //	45U Антрацит
$prais_new_051 = 100; //	46U Антрацит
$prais_new_052 = 100; //	45U Аляска
$prais_new_053 = 100; //	46U Аляска
$prais_new_054 = 100; //	48U Чёрный матовый
$prais_new_055 = 100; //	48U Тёмно-коричневый
