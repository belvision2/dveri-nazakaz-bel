<?php
$brend = 'Порта';
$material = 'экошпон, мебельный щит';
$karkas = 'LVL-брус';
...
$prais_new_029 = 269; //Порта-v4	
$prais_new_030 = 229; //Порта-21	
$prais_new_031 = 229; //Порта-22	
$prais_new_032 = 229; //Порта-23	
$prais_new_033 = 269; //Порта-м1	
$prais_new_034 = 269; //Порта-v4
$prais_new_035 = 229; //Порта-21	
$prais_new_036 = 229; //Порта-22	
$prais_new_037 = 229; //Порта-23	
$prais_new_038 = 269; //Порта-м1	
$prais_new_039 = 229; //Порта-21	
$prais_new_040 = 229; //Порта-22	
$prais_new_041 = 229; //Порта-23

$prais_new_042 = 229; //ПОРТА-23	
$prais_new_043 = 269; //V4 MAGIC FOG	
$prais_new_044 = 269; //V4 MAGIC FOG	
