...
$arr = array('Verda-ПО-C8 Итальянский орех', 'Verda-ПО-C23 Венге', 'Verda-ПО-C23 Беленый дуб', 'Verda-ПО-C3 Венге', 'Verda-ПО-C3 Беленый дуб', 'Verda-ПО-C15 Миланский орех', 'Verda-ПО-C15 Итальянский орех', 'Verda-ПО-C17(ф) Квадрат Миланский орех', 'Verda-ПО-C17(ф) Квадрат Итальянский орех', 'Verda-ПО-C17(ф) Квадрат Беленый дуб', 'Verda-ПО-C17(ф) Квадрат Венге', 'Verda-ПО-C17(ф) Тюльпан Итальянский орех', 'Verda-ПО-C17(ф) Тюльпан Миланский орех', 'Verda-ПО-C21(х) Вьюн Итальянский орех', 'Verda-ПО-C21(х) Вьюн Миланский орех', 'Verda-ПО-C21(х) Барроко Итальянский орех', 'Verda-ПО-C21(х) Барроко Миланский орех', 'Verda-ПО-C6 Итальянский орех', 'Verda-ПО-C6 Груша', 'Verda-ПО-C6 Миланский орех', 'Verda ПГ-C6 Груша', 'Verda-ПО-C2(ф) Миланский орех', 'Verda-ПО-C2(ф) Итальянский орех', 'Verda-ПО-C2 Миланский орех', 'Verda-ПГ-C2 Миланский орех', 'Verda-ПО-C2 Итальянский орех', 'Verda-ПГ-C2 Итальянский орех', 'Verda-ПО-C7 Итальянский орех', 'Verda-ПО-C7 Миланский орех', 'Verda-ПГ-C7 Итальянский орех');

$prais_new_026 = 120; //	Verda-ПО-C8 Итальянский орех
$prais_new_027 = 138; //	Verda-ПО-C23 Венге
$prais_new_028 = 138; //	Verda-ПО-C23 Беленый дуб
$prais_new_029 = 131; //	Verda-ПО-C3 Венге
$prais_new_030 = 131; //	Verda-ПО-C3 Беленый дуб
$prais_new_031 = 113; //	Verda-ПО-C15 Миланский орех
$prais_new_032 = 113; //	Verda-ПО-C15 Итальянский орех
$prais_new_033 = 126; //	Verda-ПО-C17(ф) Квадрат Миланский орех
$prais_new_034 = 126; //	Verda-ПО-C17(ф) Квадрат Итальянский орех
$prais_new_035 = 133; //	Verda-ПО-C17(ф) Квадрат Беленый дуб
$prais_new_036 = 133; //	Verda-ПО-C17(ф) Квадрат Венге
$prais_new_037 = 126; //	Verda-ПО-C17(ф) Тюльпан Итальянский орех
$prais_new_038 = 126; //	Verda-ПО-C17(ф) Тюльпан Миланский орех
$prais_new_039 = 138; //	Verda-ПО-C21(х) Вьюн Итальянский орех
$prais_new_040 = 138; //	Verda-ПО-C21(х) Вьюн Миланский орех
$prais_new_041 = 138; //	Verda-ПО-C21(х) Барроко Итальянский орех
$prais_new_042 = 138; //	Verda-ПО-C21(х) Барроко Миланский орех
$prais_new_043 = 93; //	Verda-ПО-C6 Итальянский орех
$prais_new_044 = 83; //	Verda-ПО-C6 Груша
$prais_new_045 = 93; //	Verda-ПО-C6 Миланский орех
$prais_new_046 = 83; //	Verda-ПГ-C6 Груша
$prais_new_047 = 120; //	Verda-ПО-C2(ф) Миланский орех
$prais_new_048 = 120; //	Verda-ПО-C2(ф) Итальянский орех
$prais_new_049 = 116; //	Verda-ПО-C2 Миланский орех
$prais_new_050 = 116; //	Verda-ПГ-C2 Миланский орех
$prais_new_051 = 116; //	Verda-ПО-C2 Итальянский орех
$prais_new_052 = 116; //	Verda-ПГ-C2 Итальянский орех
$prais_new_053 = 113; //	Verda-ПО-C7 Итальянский орех
$prais_new_054 = 113; //	Verda-ПО-C7 Миланский орех
$prais_new_055 = 99; //	Verda-ПГ-C7 Итальянский орех
