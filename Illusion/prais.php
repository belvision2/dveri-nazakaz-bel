...
$arr = array('Аврора, стекло матовое', 'Диана, стекло матовое', 'Анжелика, стекло матовое', 'Грация, стекло матовое', 'Изабелла, стекло матовое', 'Линда, стекло матовое', 'Мария, стекло матовое', 'Офелия, стекло матовое', 'Ребекка, стекло матовое', 'Сабина, стекло матовое', 'София, стекло матовое', 'Стелла, стекло матовое', 'Эльвира, стекло матовое', 'Эмилия, стекло матовое', 'Юлиана, стекло матовое');




$prais_new_026 = 257; //	Аврора, стекло матовое
$prais_new_027 = 297; //	Диана, стекло матовое
$prais_new_028 = 218; //	Анжелика, стекло матовое
$prais_new_029 = 257; //	Грация, стекло матовое
$prais_new_030 = 218; //	Изабелла, стекло матовое
$prais_new_031 = 297; //	Линда, стекло матовое
$prais_new_032 = 218; //	Мария, стекло матовое
$prais_new_033 = 218; //	Офелия, стекло матовое
$prais_new_034 = 267; //	Ребекка, стекло матовое
$prais_new_035 = 241; //	Сабина, стекло матовое
$prais_new_036 = 241; //	София, стекло матовое
$prais_new_037 = 241; //	Стелла, стекло матовое
$prais_new_038 = 251; //	Эльвира, стекло матовое
$prais_new_039 = 297; //	Эмилия, стекло матовое
$prais_new_040 = 297; //	Юлиана, стекло матовое
