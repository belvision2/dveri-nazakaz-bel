...
$arr = array('Orange (Оранжевый), эмалит', 'Red (Красный), эмалит', 'Black (Черный), эмалит', 'White (Белый), эмалит', 'Герда белая, эмалит', 'Герда черная, эмалит');

$prais_new_026 = 305; //	Orange (Оранжевый), эмалит
$prais_new_027 = 305; //	Red (Красный), эмалит
$prais_new_028 = 305; //	Black (Черный), эмалит
$prais_new_029 = 305; //	White (Белый), эмалит
$prais_new_030 = 305; //	Герда белая, эмалит
$prais_new_031 = 305; //	Герда черная, эмалит
