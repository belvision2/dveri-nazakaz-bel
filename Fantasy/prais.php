...
$arr = array('Башня, стекло матовое', 'Город, стекло матовое', 'Дельфин, стекло матовое', 'Капитель, стекло матовое', 'Море, стекло матовое', 'Ночь, стекло матовое', 'Тауэр, стекло матовое');




$prais_new_026 = 406; //	Башня, стекло матовое
$prais_new_027 = 406; //	Город, стекло матовое
$prais_new_028 = 284; //	Дельфин, стекло матовое
$prais_new_029 = 406; //	Капитель, стекло матовое
$prais_new_030 = 406; //	Море, стекло матовое
$prais_new_031 = 284; //	Ночь, стекло матовое
$prais_new_032 = 406; //	Тауэр, стекло матовое
