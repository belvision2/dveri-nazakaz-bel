...
$arr = array('Аллиум, стекло матовое', 'Амариллис, стекло матовое', 'Лизиантус, стекло матовое', 'Лилия, стекло матовое', 'Лотос, стекло матовое', 'Магнолия, стекло матовое', 'Орхидея, стекло матовое');




$prais_new_026 = 329; //	Аллиум, стекло матовое
$prais_new_027 = 363; //	Амариллис, стекло матовое
$prais_new_028 = 428; //	Лизиантус, стекло матовое
$prais_new_029 = 329; //	Лилия, стекло матовое
$prais_new_030 = 329; //	Лотос, стекло матовое
$prais_new_031 = 270; //	Магнолия, стекло матовое
$prais_new_032 = 352; //	Орхидея, стекло матовое
