...
$arr = array('Animal-(Зверь), прозрачное стекло', 'Books-(Книги), прозрачное стекло', 'Building-(Здание), прозрачное стекло', 'Flowers-(Цветы), прозрачное стекло', 'Forest-(Лес), прозрачное стекло', 'Guitar-(Гитара), прозрачное стекло', 'Nature-(Природа), прозрачное стекло', 'Sea-(Море), прозрачное стекло', 'Skyscrapers-(Небоскребы), прозрачное стекло', 'Sunset-(Закат), прозрачное стекло', 'Town-(Город), прозрачное стекло', 'Venice-(Венеция), прозрачное стекло', 'Waterfall-(Водопад), прозрачное стекло', 'Wave-(Волна), прозрачное стекло', 'Woman-(Леди), прозрачное стекло');

$prais_new_026 = 304; //	Animal-(Зверь), прозрачное стекло
$prais_new_027 = 304; //	Books-(Книги), прозрачное стекло
$prais_new_028 = 304; //	Building-(Здание), прозрачное стекло
$prais_new_029 = 304; //	Flowers-(Цветы), прозрачное стекло
$prais_new_030 = 304; //	Forest-(Лес), прозрачное стекло
$prais_new_031 = 304; //	Guitar-(Гитара), прозрачное стекло
$prais_new_032 = 304; //	Nature-(Природа), прозрачное стекло
$prais_new_033 = 304; //	Sea-(Море), прозрачное стекло
$prais_new_034 = 304; //	Skyscrapers-(Небоскребы), прозрачное стекло
$prais_new_035 = 304; //	Sunset-(Закат), прозрачное стекло
$prais_new_036 = 304; //	Town-(Город), прозрачное стекло
$prais_new_037 = 304; //	Venice-(Венеция), прозрачное стекло
$prais_new_038 = 304; //	Waterfall-(Водопад), прозрачное стекло
$prais_new_039 = 304; //	Wave-(Волна), прозрачное стекло
$prais_new_040 = 304; //	Woman-(Леди), прозрачное стекло
